...
Informar o CEP da localização da ocorrência;
...
Passos
Clone o repositório:
git clone https://github.com/seu-usuario/reclama-mairinque.git
Acesse a pasta do projeto:
cd reclama-mairinque
...
Anexa uma imagem do problema.
Informa o CEP da localização.
A ocorrência fica disponível para análise e acompanhamento.
🤝 Contribuição
